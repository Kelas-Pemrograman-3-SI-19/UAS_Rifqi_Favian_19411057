        ...
        <div class="row">
          ...
          <div class="col">
            <q-banner inline-actions class="text-blue-grey-14">
              ...
              <div>Data Transaksi Pemesanan Kamar Anda</div>
            </q-banner>
          </div>
        </div>
      </div>
        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            <q-td key="namaKamar" :props="props">
              {{ props.row.dataKamar[0].namaKamar }}
            </q-td>
            ...
            <q-td key="aksi" :props="props">
                <q-btn :disable="props.row.status !== 2" label="Konfirmasi Pemesanan" @click="confirm(props.row._id)" class="q-ml-sm" color="positive" unelevated />
            </q-td>
          </q-tr>
        </template>
      </q-table>
...
export default {
  ...
  data () {
    return {
      columns: [
        { name: 'namaKamar', align: 'center', label: 'Nama Kamar', field: 'namaKamar', sortable: true },
        { name: 'harga', align: 'center', label: 'Harga', field: 'harga', sortable: true },
        { name: 'jumlah', align: 'center', label: 'Jumlah Pesanan', field: 'jumlah', sortable: true },
  ...
  methods: {
    ...
    confirm (id) {
      this.$q.dialog({
        title: 'Konfirmasi',
        message: 'Apakah Anda Sudah Menerima Bukti Pemesanan ?',
        cancel: true,
        persistent: true
      }).onOk(() => {
