  ...
  <q-page padding>
        ...
        <div class="row">
          ...
          <div class="col">
            <q-banner inline-actions class="text-blue-grey-14">
              ...
              <div>Data Transaksi Pemesanan Kamar Hotel</div>
            </q-banner>
          </div>
        </div>
      </div>
    ...
    >
      <q-card style="width: 700px; max-width: 80vw">
        <q-card-section>
          <div class="text-h6">Detail Pesanan Kamar</div>
        </q-card-section>
        ...
        <q-card-section class="q-pt-none">
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="text-weight-bold">
                {{activeData.dataKamar[0].namaKamar}}
              </div>
            </div>
            <div class="col">
              <div class="text-caption">
...
export default {
  ...
  data () {
    return {
      columns: [
        ...
        { name: 'jumlah', align: 'left', label: 'Jumlah Pesan', field: 'jumlah', sortable: true },
        { name: 'total', align: 'left', label: 'Total', field: 'total', sortable: true },
        { name: 'nama', align: 'left', label: 'Nama Pemesan', field: 'nama', sortable: true },
  ...
  methods: {
    ...
    confirm (id) {
      this.$q.dialog({
        title: 'Konfirmasi',
        message: 'Apakah Anda Yakin Mengkonfirmasi Pemesanan Ini?',
        cancel: true,
        persistent: true
      }).onOk(() => {
