            ...
            <div class="row">
              ...
              <div class="col">
                <q-banner inline-actions class="text-blue-grey-14">
                  <div class="text-h6">Input Kamar Hotel</div>
                  <div>Input Kamar Hotel Terbaru</div>
                </q-banner>
              </div>
            </div>
          </div>
          ...
          <q-card-section class="row">
            ...
            >
              <q-input
                ...
                filled
                label="Nama Kamar"
                :rules="[ val => val && val.length > 0 || 'Mohon Isi Nama Kamar']"
              />
...
export default {
  ...
  methods: {
    onSubmit () {
      ...
      this.$axios.post('kamar/insert', formData)
        .then(res => {
          if (res.data.sukses) {
